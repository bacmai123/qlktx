...
public  class QuanLyPhong_140 extends javax.swing.JFrame {
    ...
    public QuanLyPhong_140(String maPhong) throws ClassNotFoundException, SQLException {
    ...
    private void Xoa_ButtonActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_Xoa_ButtonActionPerformed
 ...
 int result = JOptionPane.showConfirmDialog(null,"Bạn có chắc chắn muốn xóa không");
    ...
    private void Sua_ButtonActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException, SQLException {//GEN-FIRST:event_Sua_ButtonActionPerformed
    ...
    private void Them_ButtonActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException, SQLException {//GEN-FIRST:event_Them_ButtonActionPerformed
